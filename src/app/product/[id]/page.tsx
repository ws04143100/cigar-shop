            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
              ...
              >
                <div className="w-14 h-14 bg-black rounded-2xl flex items-center justify-center">
                  <svg className="w-9 h-9 text-white" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M120 40C75.2 40 40 75.2 40 120C40 164.8 75.2 200 120 200C147.6 200 171.6 183.6 183.6 160V128C183.6 114.4 172.8 102.8 160 102.8C156 102.8 147.6 106.4 147.6 112C147.6 120 156 128 164 128H172.8C188.4 128 200 116 200 100C200 76.4 180.4 56 156 56C141.2 56 128 64 120 72V40Z" fill="white"/>
                  </svg>
                </div>
              ...
              >
                <div className="w-14 h-14 bg-red-500 rounded-2xl flex items-center justify-center">
                  <svg className="w-9 h-9 text-white" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="240" height="240" rx="48" fill="#FF2442"/>
                    <path d="M100 160C100 160 120 140 140 140C160 140 180 160 180 160" stroke="white" strokeWidth="8" strokeLinecap="round"/>
                    <path d="M120 80V140" stroke="white" strokeWidth="8" strokeLinecap="round"/>
                    <circle cx="120" cy="60" r="20" stroke="white" strokeWidth="8"/>
                  </svg>
                </div>
